...
function checkAppElement(methods, instanceData, folders, element, tag, checkElementOptions, isNativeContext) {
    return __awaiter(this, void 0, void 0, function () {
        var isMobile, executor, _a, devicePixelRatio, fileName, isLandscape, compareOptions, executeCompareOptions;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    isMobile = instanceData.isMobile;
                    executor = methods.executor;
                    return [4, (0, saveAppElement_js_1.default)(methods, instanceData, folders, element, tag, checkElementOptions, isNativeContext)];
                case 1:
                    ...
                    return [2, (0, images_js_1.executeImageCompare)(executor, executeCompareOptions)];
            }
        });
    });
}
exports.default = checkAppElement;
//# sourceMappingURL=checkAppElement.js.map