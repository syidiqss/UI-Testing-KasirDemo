...
export default function checkAppScreen(methods: Methods, instanceData: InstanceData, folders: Folders, tag: string, checkScreenOptions: CheckScreenOptions, isNativeContext: boolean): Promise<ImageCompareResult | number>;
