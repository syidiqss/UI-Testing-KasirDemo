...
function saveAppScreen(methods, instanceData, folders, tag, saveScreenOptions, isNativeContext) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, addIOSBezelCorners, formatImageName, logLevel, savePerInstance, browserName, browserVersion, deviceName, devicePixelRatio, deviceScreenSize, isIOS, isMobile, logName, platformName, platformVersion, base64Image, afterOptions;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = saveScreenOptions.wic, addIOSBezelCorners = _a.addIOSBezelCorners, formatImageName = _a.formatImageName, logLevel = _a.logLevel, savePerInstance = _a.savePerInstance;
                ...
                case 1:
                    base64Image = _b.sent();
                    if (!(isIOS && addIOSBezelCorners)) return [3, 3];
...
exports.default = saveAppScreen;
//# sourceMappingURL=saveAppScreen.js.map