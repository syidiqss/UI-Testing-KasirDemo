...
function saveWebScreen(methods, instanceData, folders, tag, saveScreenOptions, isNativeContext) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, addressBarShadowPadding, addIOSBezelCorners, formatImageName, logLevel, savePerInstance, toolBarShadowPadding, disableCSSAnimation, enableLayoutTesting, hideScrollBars, hideElements, removeElements, waitForFontsLoaded, beforeOptions, enrichedInstanceData, browserName, browserVersion, deviceName, _b, devicePixelRatio, innerHeight, innerWidth, isLandscape, outerHeight, outerWidth, screenHeight, screenWidth, isAndroidChromeDriverScreenshot, isAndroidNativeWebScreenshot, isIOS, isMobile, isTestInBrowser, logName, name, platformName, platformVersion, base64Image, screenRectangleOptions, rectangles, croppedBase64Image, afterOptions;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    disableCSSAnimation = saveScreenOptions.method.disableCSSAnimation !== undefined
                        ? Boolean(saveScreenOptions.method.disableCSSAnimation)
                        : saveScreenOptions.wic.disableCSSAnimation;
                    enableLayoutTesting = saveScreenOptions.method.enableLayoutTesting !== undefined
                        ? Boolean(saveScreenOptions.method.enableLayoutTesting)
                        : saveScreenOptions.wic.enableLayoutTesting;
                    hideScrollBars = saveScreenOptions.method.hideScrollBars !== undefined
                    ...
                    waitForFontsLoaded = saveScreenOptions.method.waitForFontsLoaded !== undefined
...
exports.default = saveWebScreen;
//# sourceMappingURL=saveWebScreen.js.map