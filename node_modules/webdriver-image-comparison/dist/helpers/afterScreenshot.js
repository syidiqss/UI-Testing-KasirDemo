...
function afterScreenshot(executor, options) {
    return __awaiter(this, void 0, void 0, function () {
        var actualFolder, base64Image, disableCSSAnimation, enableLayoutTesting, fileNameOptions, filePath, hideElements, noScrollBars, isLandscape, isNativeContext, logLevel, platformName, removeElements, path, fileName, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    actualFolder = options.actualFolder, base64Image = options.base64Image, disableCSSAnimation = options.disableCSSAnimation, enableLayoutTesting = options.enableLayoutTesting, fileNameOptions = options.fileName, filePath = options.filePath, hideElements = options.hideElements, noScrollBars = options.hideScrollBars, isLandscape = options.isLandscape, isNativeContext = options.isNativeContext, logLevel = options.logLevel, platformName = options.platformName, removeElements = options.removeElements;
                    path = (0, utils_js_1.getAndCreatePath)(actualFolder, filePath);
                    fileName = (0, utils_js_1.formatFileName)(fileNameOptions);
                    return [4, (0, images_js_1.saveBase64Image)(base64Image, (0, node_path_1.join)(path, fileName))];
                case 1:
                    _a.sent();
                    if (!!isNativeContext) return [3, 11];
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (!((hideElements && hideElements.length > 0) || (removeElements && removeElements.length > 0))) return [3, 7];
                    _a.label = 4;
                case 4:
                    _a.trys.push([4, 6, , 7]);
                    return [4, executor(hideRemoveElements_js_1.default, { hide: hideElements, remove: removeElements }, false)];
                case 5:
                    _a.sent();
                    return [3, 7];
                case 6:
                ...
                case 8:
                    ...
                    _a.label = 9;
                case 9:
                    if (!enableLayoutTesting) return [3, 11];
