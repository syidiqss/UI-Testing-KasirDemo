...
var getScreenDimensions_js_1 = __importDefault(require("../clientSideScripts/getScreenDimensions.js"));
function getEnrichedInstanceData(executor, instanceOptions, addShadowPadding) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, executor(getScreenDimensions_js_1.default)];
                case 1:
                    browserData = _a.sent();
                    ...
                    isTestInBrowser = (0, utils_js_1.checkTestInBrowser)(browserName);
                    isTestInMobileBrowser = (0, utils_js_1.checkTestInMobileBrowser)(platformName, browserName);
                    isAndroidNativeWebScreenshot = (0, utils_js_1.checkAndroidNativeWebScreenshot)(platformName, nativeWebScreenshot);
                    isAndroidChromeDriverScreenshot = (0, utils_js_1.checkAndroidChromeDriverScreenshot)(platformName, nativeWebScreenshot);
